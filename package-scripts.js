...
module.exports = {
  scripts: {
    ...
    /**
     * Runs Prettier format over your project
     */
    format: {
      script: prettier(`./src/**/*.ts`),
      description: "Format Project over your project",
    },
    /**
    ...
    db: {
      new: {
        script: series(
          "nps banner.new",
          "nps config",
          runFast("./node_modules/typeorm/cli.js migration:create -n "),
        ),
      ...
      generate: {
        script: series(
          ...
          "nps config",
          runFast(
            "./node_modules/typeorm/cli.js migration:generate -n refactoring",
          ),
        ),
        description: "Migrates the database to newest version available",
      },
